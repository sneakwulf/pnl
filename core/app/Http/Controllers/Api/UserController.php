...
class UserController extends Controller
{
    ...
    public function accountDelete(Request $request)
    {
        ...
        if (!Hash::check($request->password, $user->password)) {
            return getResponse('invalid_password', 'error', 'Invalid Password');
        }
        ...
        return getResponse('account_deleted', 'success', 'Account deleted successfully');
    }
