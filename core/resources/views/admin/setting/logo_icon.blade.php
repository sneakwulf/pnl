                        ...
                        <div class="row">
                                ...
                                <div class="image-upload">
                                    <div class="thumb">
                                        <div class="avatar-preview">
                                            <div class="profilePicPreview logoPicPrev logoPrev bg--dark" style="background-image: url({{ siteLogo() . '?' . time() }})">
                            ...
                            <div class="form-group col-xl-4">
                                ...
                                <div class="image-upload">
                                    <div class="thumb">
                                        <div class="avatar-preview">
                                            <div class="profilePicPreview logoPicPrev logoPrev" style="background-image: url({{ siteLogo(2) . '?' . time() }})">
                                                <button type="button" class="remove-image"><i class="fa fa-times"></i></button>
                                            </div>
                                        </div>
                                        <div class="avatar-edit">
                            ...
                            <div class="form-group col-xl-4">
                                ...
                                <div class="image-upload">
                                    <div class="thumb">
                                        <div class="avatar-preview">
                                            <div class="profilePicPreview logoPicPrev iconPrev" style="background-image: url({{ siteFavicon() . '?' . time() }})">
                                                <button type="button" class="remove-image"><i class="fa fa-times"></i></button>
                                            </div>
                                        </div>
                                        <div class="avatar-edit">
